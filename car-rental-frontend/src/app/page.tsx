    ...
    <div className="home-theme flex min-h-svh flex-col overflow-x-clip bg-background text-foreground">
      ...
      <main className="flex-1">
                ...
                <div className="mt-5 grid gap-3 lg:grid-cols-[1fr_1fr_auto] lg:items-stretch">
                  ...
                  >
                    ...
                    <span className="min-w-0 flex-1">
                      ...
                      <span className="mt-0.5 block text-sm text-muted">
                        Choose a listed fixed-price route
                      </span>
                    </span>
                    <ArrowRight
                      aria-hidden="true"
                  ...
                  <Link
                    href="/cars"
                    className={buttonStyles({
                      className: "h-auto min-h-14 lg:min-w-36",
                      size: "lg",
                    })}
                  >
        ...
        <section
          ...
          className="bg-white pb-16 sm:pb-20 pt-10"
        >
          <PageContainer>
            <Reveal className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 leading-7 text-muted">
                Compare real vehicle information, choose the right service, and
                keep the price visible as you book.
              </p>
            </Reveal>
            ...
            <div className="mt-10 grid gap-6 lg:gap-8">
              <Reveal>
                <article className="grid overflow-hidden rounded-[1.1rem] border border-border bg-[#f7f9fc] shadow-card lg:grid-cols-2 lg:items-stretch">
                  ...
                  <div className="flex flex-col justify-center p-6 sm:p-9 lg:p-12">
                    ...
                    <Link
                      href="/cars?serviceType=rental"
                      className="mt-7 inline-flex w-fit items-center gap-2 rounded font-semibold text-primary outline-none hover:underline focus-visible:ring-4 focus-visible:ring-[var(--ring)]"
                    >
                      Browse rental cars{" "}
              ...
              <Reveal>
                <article className="grid overflow-hidden rounded-[1.1rem] border border-border bg-[#10203d] text-white shadow-card lg:grid-cols-2 lg:items-stretch">
                  <div className="flex flex-col justify-center p-6 sm:p-9 lg:p-12">
                    <p className="text-sm font-semibold text-[#8dbbfa]">
                      Comfort from point to point
                    </p>
                    <h3 className="mt-2 text-2xl font-semibold tracking-[-0.035em] sm:text-3xl">
                      Choose a transfer with the route already defined.
                    </h3>
                    <p className="mt-4 leading-7 text-white/70">
                      Select an available pickup and destination package, see
                      its fixed price, choose your pickup time, and travel with
                      a driver.
                    </p>
                    ...
                    <Link
                      href="/cars?serviceType=transfer"
                      className="mt-7 inline-flex w-fit items-center gap-2 rounded font-semibold text-white outline-none hover:underline focus-visible:ring-4 focus-visible:ring-white/35"
                    >
                      Browse transfer rides{" "}
                      <ArrowRight aria-hidden="true" size={17} />
                    </Link>
                  </div>
                  <div className="relative min-h-64 overflow-hidden sm:min-h-80 lg:order-last lg:min-h-[25rem]">
                    ...
                    <div
                      aria-hidden="true"
                      className="absolute inset-0 bg-gradient-to-t from-[#10203d]/30 to-transparent lg:bg-gradient-to-r"
                    />
        ...
        <section
          ...
          className="border-y border-border bg-[#f7f9fc] py-16 sm:py-20"
        >
          <PageContainer>
        ...
        <section
          ...
          className="bg-[#f7faff] py-16 sm:py-20"
        >
          <PageContainer>
            <Reveal className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
              <div className="max-w-2xl">
                ...
                <p className="mt-4 leading-7 text-muted">
                  A few short stories about booking clarity, vehicle choice, and
              ...
              {reviews.map((review, index) => (
                <Reveal key={review.name} delay={index * 0.04}>
                  <figure className="flex h-full flex-col rounded-card border border-[#d5e1ef] bg-white p-5 shadow-card sm:p-6">
                    <div
                      className="flex gap-0.5 text-[#e4a11b]"
                      aria-hidden="true"
                    >
        ...
        >
          <PageContainer className="grid gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:gap-16">
            <Reveal>
              ...
              <p className="mt-4 leading-7 text-muted">
                The booking flow keeps the vehicle, trip, and customer details
                ...
                <Reveal key={step.title} delay={index * 0.04}>
                  <div className="flex gap-4 rounded-card border border-border bg-white p-5 sm:items-center sm:p-6">
                    ...
                    {index === 0 ? (
                      <MapPin
                        aria-hidden="true"
                        className="ml-auto hidden text-[#afbdd0] sm:block"
                        size={21}
                      />
                    ) : null}
                    {index === 1 ? (
              ...
              <div className="flex flex-col items-start justify-between gap-7 rounded-[1.1rem] bg-[#10203d] px-6 py-10 text-white sm:px-9 sm:py-12 lg:flex-row lg:items-center lg:px-12">
                <div className="max-w-2xl">
                  ...
                  <p className="mt-3 leading-7 text-white/70">
                    Browse the current fleet and continue through the existing
                    booking experience.
                  </p>
                </div>
                <Link
                  ...
                  className={buttonStyles({
                    className:
                      "border-white bg-white text-[#10203d] hover:bg-[#edf3fb]",
                    size: "lg",
                    variant: "secondary",
                  })}
                >
