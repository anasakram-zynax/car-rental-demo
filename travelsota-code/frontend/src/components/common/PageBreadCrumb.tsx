...
interface BreadcrumbProps { pageTitle: string; }
    ...
    <div className="flex flex-wrap items-center justify-between gap-3">
      ...
      <nav>
        <ol className="flex items-center gap-1.5">
          <li>
            <Link className="inline-flex items-center gap-1.5 text-sm text-gray-500 dark:text-gray-400 hover:text-brand-600 dark:hover:text-brand-400 transition-colors" href="/">
              Home
          ...
          <li className="text-sm font-medium text-gray-800 dark:text-white/90">{pageTitle}</li>
        </ol>
      </nav>
    </div>
  );
