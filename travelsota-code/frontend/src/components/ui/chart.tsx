...
// Reference-2 (Shadboard) shadcn chart wrapper port — adapted to our cn util.
// Provides ChartContainer / ChartTooltip / ChartTooltipContent / ChartLegend.
// Uses the semantic --chart-* vars (defined in globals.css) so charts follow
    ...
    <ChartContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          ...
          "flex aspect-video justify-center text-sm min-w-0 min-h-0 w-full overflow-hidden [&_.recharts-cartesian-axis-tick_text]:fill-muted-foreground [&_.recharts-cartesian-grid_line[stroke='#ccc']]:stroke-border/50 [&_.recharts-curve.recharts-tooltip-cursor]:stroke-border [&_.recharts-dot[stroke='#fff']]:stroke-transparent [&_.recharts-layer]:outline-hidden [&_.recharts-polar-grid_[stroke='#ccc']]:stroke-border [&_.recharts-radial-bar-background-sector]:fill-muted [&_.recharts-rectangle.recharts-tooltip-cursor]:fill-muted [&_.recharts-reference-line_[stroke='#ccc']]:stroke-border [&_.recharts-sector[stroke='#fff']]:stroke-transparent [&_.recharts-sector]:outline-hidden [&_.recharts-surface]:outline-hidden",
          className
        )}
        {...props}
      >
